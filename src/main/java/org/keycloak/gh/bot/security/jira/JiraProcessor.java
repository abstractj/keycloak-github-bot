...
public class JiraProcessor {
    ...
    @Inject JiraAdapter jira;       // Removed incorrect package prefix
    @Inject
    org.keycloak.gh.bot.security.jira.JiraIssueParser parser; // Removed incorrect package prefix
    ...
    private void updateGithubIssue(GHIssue issue, String cveId, JiraAdapter.JiraIssue jiraIssue) throws IOException {
        ...
        if (titleChanged || descChanged) {
            ...
            // Mark as synced using the constant from Constants.java
