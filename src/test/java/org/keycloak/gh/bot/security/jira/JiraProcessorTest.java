...
public class JiraProcessorTest {
    ...
    // We use the real parser to ensure integration works,
    // or we could mock it if we wanted strictly unit isolation.
    // Since it's a stateless utility, using the real one is fine/better.
    @Inject
    ...
    public void testProcessJiraUpdates_SyncsMatchingIssue() throws IOException {
        ...
        // Verify body update includes the header and parsed content
